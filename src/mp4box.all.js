...
ISOFile.prototype.addTrack = function (_options) {
  ...
  trak
    .add('tkhd')
    .set('flags', BoxParser.TKHD_FLAG_ENABLED | BoxParser.TKHD_FLAG_IN_MOVIE | BoxParser.TKHD_FLAG_IN_PREVIEW)
    .set('creation_time', 0)
    .set('modification_time', 0)
...
ISOFile.prototype.createSingleSampleMoof = function (sample) {
  ...
  traf
    .add('trun')
    .set('flags', BoxParser.TRUN_FLAGS_DATA_OFFSET | BoxParser.TRUN_FLAGS_DURATION | BoxParser.TRUN_FLAGS_SIZE | BoxParser.TRUN_FLAGS_FLAGS | BoxParser.TRUN_FLAGS_CTS_OFFSET)
    .set('data_offset', 0)
...
MP4Box.createFile = function (_keepMdatData, _stream) {
  ...
  var file = new ISOFile(_stream); // Ensure ISOFile is defined or imported if needed
  file.discardMdatData = !keepMdatData;
  return file;
};

// ES6 Named Exports
export { MP4Box, MP4Box as createFile };
